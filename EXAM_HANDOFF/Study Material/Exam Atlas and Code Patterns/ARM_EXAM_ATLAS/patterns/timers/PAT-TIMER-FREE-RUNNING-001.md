# PAT-TIMER-FREE-RUNNING-001: Free-running timer seed

- Recognition tag: `timing:free-running`
...
- Related exams: `E2023-02-07`, `E2024-02-12`, `E2025-01-29-A1`, `E2025-01-29-A2`, `E2025-01-29-A3`, `E2026-02-18-A1`, `E2026-02-18-A2`, `E2026-06-25-B1`, `E2026-06-25-B2`
- Tests: each related project `Tests/` and `Reports/COVERAGE_MATRIX.csv`.


## Start with actual code

- Canonical: [`free_running_timer.c`](../../../CODE_TEMPLATES/03_board/free_running_timer.c)
- Alternative: [`periodic_timer.c`](../../../CODE_TEMPLATES/03_board/periodic_timer.c)
- Code status: `COMPILED_CODE`

## Change these lines first

Use the counter as a seed/capture and do not enable the match interrupt unless required.

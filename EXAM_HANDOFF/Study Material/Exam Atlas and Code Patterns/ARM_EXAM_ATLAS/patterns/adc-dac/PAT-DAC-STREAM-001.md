# PAT-DAC-STREAM-001: DAC table streaming

- Recognition tag: `board:dac`
...
- Related exams: `E2025-01-29-A3`, `E2025-02-12-A1`, `E2025-02-12-A2`, `E2026-02-03-A1`, `E2026-02-03-A2`, `E2026-02-03-A3`, `E2026-02-18-A1`, `E2026-02-18-A2`
- Tests: each related project `Tests/` and `Reports/COVERAGE_MATRIX.csv`.


## Start with actual code

- Canonical: [`dac_table_stream.c`](../../../CODE_TEMPLATES/03_board/dac_table_stream.c)
...
Change sample table and period; keep the ISR index bounded and wrap explicitly.

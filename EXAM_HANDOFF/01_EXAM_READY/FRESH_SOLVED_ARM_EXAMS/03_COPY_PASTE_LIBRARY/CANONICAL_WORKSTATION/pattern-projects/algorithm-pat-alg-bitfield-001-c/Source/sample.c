...
static int pattern_core_vector(void) {
  return algorithm_algorithm_pat_alg_bitfield_001_c(0, 3, 4, 2) == 0x30u;
}
static int pattern_edge_vectors(void) {
  return algorithm_algorithm_pat_alg_bitfield_001_c(UINT32_MAX, 0, 8, 8) == UINT32_C(0xffff00ff) &&
         algorithm_algorithm_pat_alg_bitfield_001_c_extract(UINT32_C(0x12345678), 8, 8) == 0x56 &&
         algorithm_algorithm_pat_alg_bitfield_001_c_pack_u16(0x1234, 0x5678) ==
             UINT32_C(0x12345678) &&
         algorithm_algorithm_pat_alg_bitfield_001_c(7, 0, 31, 2) == 7;
}

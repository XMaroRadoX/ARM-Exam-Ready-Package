# mix-timer-rit-systick

Compose a board monitor using Timer, RIT, SysTick. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

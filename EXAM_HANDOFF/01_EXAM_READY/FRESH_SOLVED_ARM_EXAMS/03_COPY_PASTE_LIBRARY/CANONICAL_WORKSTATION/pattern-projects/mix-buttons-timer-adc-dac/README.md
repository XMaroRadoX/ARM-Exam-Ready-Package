# mix-buttons-timer-adc-dac

Compose a board monitor using Buttons, Timer, ADC, DAC. INT0 toggles running and KEY1 selects the output mode. ADC sets the value and analog amplitude. Timer1 streams an eight-sample waveform at 8 kHz. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

# paper-e2025-02-12-a2

Generate a 45-sample cosine waveform through the DAC at the required Timer1 threshold.
...
- 2025-02-12_ARM2-Q2: main; answer_timer1; Timer1 IRQ writes one DAC sample and wraps index; 45 samples; k=1592

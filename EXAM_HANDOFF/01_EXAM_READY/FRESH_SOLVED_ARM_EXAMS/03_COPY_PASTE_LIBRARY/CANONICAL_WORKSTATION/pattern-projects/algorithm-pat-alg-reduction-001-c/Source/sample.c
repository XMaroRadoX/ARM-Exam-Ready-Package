...
static int pattern_core_vector(void) {
  int32_t a[] = {-2, 5, 1};
  algorithm_algorithm_pat_alg_reduction_001_c_signed_result_t r;
  return algorithm_algorithm_pat_alg_reduction_001_c(a, 3, &r) && r.minimum == -2 && r.maximum == 5 &&
         r.sum == 4;
}
static int pattern_edge_vectors(void) {
  int32_t a[] = {INT32_MIN, INT32_MAX};
  uint32_t u[] = {0, UINT32_MAX};
  algorithm_algorithm_pat_alg_reduction_001_c_signed_result_t s;
  algorithm_algorithm_pat_alg_reduction_001_c_unsigned_result_t r;
  return !algorithm_algorithm_pat_alg_reduction_001_c(NULL, 0, &s) &&
         algorithm_algorithm_pat_alg_reduction_001_c(a, 2, &s) && s.sum == -1 &&
         algorithm_algorithm_pat_alg_reduction_001_c_unsigned(u, 2, &r) && r.sum == UINT32_MAX;
}

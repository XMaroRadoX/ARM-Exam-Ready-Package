...
void algorithm_algorithm_pat_alg_merge_sort_001_assembly(int32_t *a, uint32_t n, int32_t *scratch);



static int pattern_core_vector(void) {
  int32_t a[] = {3, -1, 2}, t[3];
  algorithm_algorithm_pat_alg_merge_sort_001_assembly(a, 3, t);
  return a[0] == -1 && a[1] == 2 && a[2] == 3;
}
static int pattern_edge_vectors(void) {
  int32_t halves[] = {1, 3, 2, 4, 987654}, work[5] = {0,0,0,0,987654};
  merge(halves, work, 0, 2, 4);
  if (halves[0]!=1 || halves[1]!=2 || halves[2]!=3 || halves[3]!=4 || halves[4]!=987654 || work[4]!=987654) return 0;
  int32_t a[] = {2, 2, 1}, t[3];
  algorithm_algorithm_pat_alg_merge_sort_001_assembly(a, 0, t);
  algorithm_algorithm_pat_alg_merge_sort_001_assembly(a, 3, t);

# mix-joystick-timer-systick

Compose a board monitor using Joystick, Timer, SysTick. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

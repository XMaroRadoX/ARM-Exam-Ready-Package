# task-stopwatch-polling

Elapsed hundredths advance only while running; INT0 pauses/resumes; KEY2 restarts.

## Run and inspect

100 steps: 1 second; pause for 100 steps: no elapsed advance.

...
static int pattern_core_vector(void) {
  ...
  return algorithm_algorithm_pat_alg_packed_matmul_001_assembly(i, i) == i;
}
static int pattern_edge_vectors(void) {
  uint64_t identity = UINT64_C(0x8040201008040201);
  return algorithm_algorithm_pat_alg_packed_matmul_001_assembly(0, identity) == 0 &&
         algorithm_algorithm_pat_alg_packed_matmul_001_assembly(identity, 0) == 0;
}

...
Compose a board monitor using Joystick, RIT. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

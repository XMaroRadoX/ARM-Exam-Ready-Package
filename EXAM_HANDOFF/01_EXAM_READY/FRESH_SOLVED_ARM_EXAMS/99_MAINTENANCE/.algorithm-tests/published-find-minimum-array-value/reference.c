 ...
 * Contract: Return the minimum signed value. Empty input or a null required pointer
 * returns 0 without writing. Equal values keep the first candidate. Method:

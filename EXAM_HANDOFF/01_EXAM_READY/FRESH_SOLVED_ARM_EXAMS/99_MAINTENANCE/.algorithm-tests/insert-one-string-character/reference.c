 ...
 * Contract: Insert one non-NUL byte before index, where index may equal length. Require a valid current terminator and one spare byte. Invalid input writes nothing.
 * Method:

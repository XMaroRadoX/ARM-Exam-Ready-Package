 ...
 * Contract: Sum cells in the first or last row or column exactly once. Dimensions must be at most 256. A zero dimension returns zero and permits a null matrix.
 * Method:

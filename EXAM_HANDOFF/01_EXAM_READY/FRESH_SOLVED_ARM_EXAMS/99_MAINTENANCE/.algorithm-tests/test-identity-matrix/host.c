 ...
 * Contract: Return 1 when diagonal cells are one and every other cell is zero. size must be at most 256. The empty 0x0 matrix is accepted; a null nonempty matrix is invalid and returns 0.
 * Method:

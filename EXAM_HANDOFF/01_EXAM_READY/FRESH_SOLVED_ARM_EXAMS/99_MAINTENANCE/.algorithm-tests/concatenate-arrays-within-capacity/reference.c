 ...
 * Contract: Write left followed by right. Reject count overflow, insufficient capacity, or invalid nonempty pointers before writing. The output must not overlap either input. Empty inputs are allowed.
 * Method:

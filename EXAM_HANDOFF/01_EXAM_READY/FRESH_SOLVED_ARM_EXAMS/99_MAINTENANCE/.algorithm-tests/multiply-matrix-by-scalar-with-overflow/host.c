 ...
 * Contract: Multiply every cell by scalar in signed int32_t. Require dimensions at most 256, enough disjoint output, and no overflow. A full preflight prevents partial writes.
 * Method:

 ...
 * Contract: Return the signed maximum in one column. Require dimensions 1..256, a valid selected index, and valid pointers. Invalid input writes nothing.
 * Method:
...
out=77;CHECK(!matrix_column_maximum_i32(a,2,3,3,&out)&&out==77);

 ...
 * Contract: Clear and fill ten counters for the magnitude digits of value. Zero contributes one zero digit. The unsigned-magnitude conversion handles INT32_MIN. A null table fails.
 * Method:

 ...
 * Contract: Return 1 when every adjacent pair is in nondecreasing signed order. Empty and one-element arrays are ascending; a null pointer is valid only for count zero.
 * Method:

 ...
 * Contract: Return -1, 0, or 1 after folding ASCII A-Z to lowercase. Return 2 if either string is null or lacks NUL within its capacity. Non-ASCII bytes compare unchanged.
 * Method:

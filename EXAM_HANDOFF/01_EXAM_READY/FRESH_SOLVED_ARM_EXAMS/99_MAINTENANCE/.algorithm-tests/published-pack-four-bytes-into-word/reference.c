 ...
 * Contract: Pack first into bits 31..24, second into 23..16, third into 15..8, and
 * fourth into 7..0. The name describes this logical big-endian display order; no memory
 * access occurs. Method:

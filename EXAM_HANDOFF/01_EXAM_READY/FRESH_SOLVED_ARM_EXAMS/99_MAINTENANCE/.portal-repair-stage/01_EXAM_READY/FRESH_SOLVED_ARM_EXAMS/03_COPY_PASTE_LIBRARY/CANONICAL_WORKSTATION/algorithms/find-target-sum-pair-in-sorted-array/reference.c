 ...
 * Contract: Input must be ascending. Find two distinct indexes whose exact 64-bit sum
 * equals target. Output pointers must be valid and distinct; failure writes nothing.
 * Method:

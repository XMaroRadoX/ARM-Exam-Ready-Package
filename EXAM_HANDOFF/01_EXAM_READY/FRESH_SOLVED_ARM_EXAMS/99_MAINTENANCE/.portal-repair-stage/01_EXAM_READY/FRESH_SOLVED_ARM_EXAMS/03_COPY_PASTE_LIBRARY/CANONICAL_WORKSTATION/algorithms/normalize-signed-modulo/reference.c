 ...
 * Contract: Require modulus>0. Return the unique result in 0..modulus-1 that is
 * congruent to value. Invalid input returns 0 without writing. Method:

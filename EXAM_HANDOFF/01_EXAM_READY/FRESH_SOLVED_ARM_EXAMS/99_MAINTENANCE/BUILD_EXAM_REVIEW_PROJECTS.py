...
def main():
    ...
    results=json.loads((HERE/'QUESTION_NATIVE_BUILDS.json').read_text()) if (HERE/'QUESTION_NATIVE_BUILDS.json').exists() else {}
    records=[prepare(q,r) for q,r in REVIEWS.items() if len(sys.argv)==1 or q in sys.argv[1:]]

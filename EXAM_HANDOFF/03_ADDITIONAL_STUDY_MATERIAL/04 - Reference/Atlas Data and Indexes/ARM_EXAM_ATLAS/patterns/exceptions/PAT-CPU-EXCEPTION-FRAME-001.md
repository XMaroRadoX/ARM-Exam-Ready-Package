# PAT-CPU-EXCEPTION-FRAME-001: MSP/PSP exception-frame selection

- Recognition tag: `cpu:exception-frame`
...
- Related exams: `E2023-02-24`
- Tests: each related project `Tests/` and `Reports/COVERAGE_MATRIX.csv`.


## Start with actual code

- Canonical: [`svc_handler.s`](../../../../../02%20-%20Code%20Recipes/07%20-%20Interrupts%20and%20Exceptions/svc_handler.s)
- Alternative: [`reset_handler.s`](../../../../../02%20-%20Code%20Recipes/07%20-%20Interrupts%20and%20Exceptions/reset_handler.s)
- Code status: `COMPILED_CODE`

## Change these lines first

Test EXC_RETURN bit 2 before selecting MSP or PSP; preserve EXC_RETURN in LR.

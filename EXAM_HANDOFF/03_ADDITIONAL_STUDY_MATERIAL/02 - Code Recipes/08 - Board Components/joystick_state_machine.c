/* Complete project and replacement instructions: ../../../01_EXAM_READY/FRESH_SOLVED_ARM_EXAMS/03_COPY_PASTE_LIBRARY/CANONICAL_WORKSTATION/pattern-projects/game-bulls-cows/README.md
 * Open ../../../01_EXAM_READY/FRESH_SOLVED_ARM_EXAMS/03_COPY_PASTE_LIBRARY/CANONICAL_WORKSTATION/pattern-projects/game-bulls-cows/sample.uvprojx; use its matching assembly file. */
#include <stdint.h>
#include "exam_api.h"
#include "LPC17xx.h"
enum {

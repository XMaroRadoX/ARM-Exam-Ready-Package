...
EXPECTED_NAV = ["Home", "Courses", "In the Exam", "Past Exams", "Solution Patterns", "API", "Algorithms", "Guides"]
EXPECTED_COUNTS = {"exams": 23, "questions": 48, "patterns": 85, "api": 52, "algorithms": 169, "peripheral_lessons": 14}
...
def verify() -> list[str]:
    ...
    if actual_counts != EXPECTED_COUNTS: errors.append(f"Coverage differs: {actual_counts}")
    expected_pages = {"exams": 72, "patterns": 86, "api": 53, "algorithms": 170, "guides": 24}
...
def main() -> int:
    ...
    print("Coverage: 23 exams, 48 questions, 85 patterns, 52 API calls, 169 algorithm entries, 14 peripheral lessons, 9 goal guides")

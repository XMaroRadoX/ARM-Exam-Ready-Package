...
Likely wording: define constants initialized reserved aligned exported data.

## C contract and variants

Primary export: `uint32_t pat_data_asm_objects_001(const uint32_t *values, uint32_t count);`
...
- [Readable C](../../../../../02%20-%20Code%20Recipes/11%20-%20Maximum%20Algorithm%20Reference/PAT-DATA-ASM-OBJECTS-001/c/reference.c)
- [ARMASM implementation](../../../../../02%20-%20Code%20Recipes/11%20-%20Maximum%20Algorithm%20Reference/PAT-DATA-ASM-OBJECTS-001/arm/implementation.s)
...
|---|---|
| `R0` | `values` — `const uint32_t *values` |
...
- [E2023-02-07-Q1](../../exams/2023/2023-02-07/Q1_ASSEMBLY.md)

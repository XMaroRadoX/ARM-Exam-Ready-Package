...
static int pattern_core_vector(void) {
  return algorithm_trial_prime_factorization(29) &&
         !algorithm_trial_prime_factorization(21) &&
         !algorithm_trial_prime_factorization(1);
}
static int pattern_edge_vectors(void) {
  uint32_t f[4] = {0};
  return algorithm_trial_prime_factorization(2) &&
         !algorithm_trial_prime_factorization(0) &&
         algorithm_trial_prime_factorization_factorize(12, f, 4) == 3 && f[0] == 2 &&
         f[1] == 2 && f[2] == 3 &&
         algorithm_trial_prime_factorization_factorize(1, f, 4) == 0;
}

...
static int pattern_core_vector(void) {
  uint32_t a[] = {1, 2, 1};
  return algorithm_component_label_merge(a, 3, 1, 2, 3) == 2 && a[0] == 2 && a[2] == 2;
}
static int pattern_edge_vectors(void) {
  uint32_t a[] = {1, 1};
  return algorithm_component_label_merge(a, 2, 1, 2, 1) == 0 &&
         algorithm_component_label_merge(NULL, 0, 1, 2, 0) == 0;
}

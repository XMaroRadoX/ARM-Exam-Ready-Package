...
pat_alg_quicksort_001(property_a,12);
...
pat_alg_quicksort_001(property_a,5);
CHECK(property_a[0]==(-19LL));
...
pat_alg_quicksort_001(property_a,8);
...
pat_alg_quicksort_001(property_a,13);
...
pat_alg_quicksort_001(property_a,20);

...
Likely wording: graph traversal explicit queue.

## C contract and variants

Primary export: `uint32_t pat_alg_bfs_001(const uint8_t *adj, uint32_t n, uint32_t start, uint8_t *seen, uint32_t *q);`
...
- [Readable C](../../../../../02%20-%20Code%20Recipes/11%20-%20Maximum%20Algorithm%20Reference/PAT-ALG-BFS-001/c/reference.c)
- [ARMASM implementation](../../../../../02%20-%20Code%20Recipes/11%20-%20Maximum%20Algorithm%20Reference/PAT-ALG-BFS-001/arm/implementation.s)
...
static int pattern_edge_vectors(void) {
  uint8_t a[1] = {0}, s[1] = {0};
  uint32_t q[1];
  return pat_alg_bfs_001(a, 1, 0, s, q) == 1 &&
         pat_alg_bfs_001(a, 1, 1, s, q) == 0 &&

...
def verify() -> list[str]:
    ...
    for path in question_pages:
        text = path.read_text(encoding="utf-8", errors="replace")
        required = ["Exact contract", "Solution reasoning", "Worked trace", "Code explanation", "Relevant mistakes", "Validation evidence for this answer", "Original paper", "Show complete"]

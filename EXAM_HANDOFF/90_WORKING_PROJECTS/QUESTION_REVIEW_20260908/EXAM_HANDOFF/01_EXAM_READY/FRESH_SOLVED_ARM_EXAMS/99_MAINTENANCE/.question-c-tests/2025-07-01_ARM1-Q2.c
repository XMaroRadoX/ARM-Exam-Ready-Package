...
int expected[10]={9,9,8,8,11,8,9,9,9,10};CHECK(mock_period[0]==3000);
for(int i=0;i<10;i++){TIMER0_IRQHandler();CHECK(mock_led==(1u<<(11-expected[i])));}CHECK(mock_calls==10&&!mock_running[0]);TIMER0_IRQHandler();CHECK(mock_calls==10);
return 0;}

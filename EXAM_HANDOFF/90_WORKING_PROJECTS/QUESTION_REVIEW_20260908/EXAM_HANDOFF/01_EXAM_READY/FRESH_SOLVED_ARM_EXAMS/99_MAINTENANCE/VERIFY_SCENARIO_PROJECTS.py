...
def main():
    ...
    coverage=[{'projects':json.loads((HERE/'SCENARIO_MANIFEST.json').read_text())}]
    results_path=HERE/'SCENARIO_NATIVE_BUILDS.json'
    ...
    results={};logs=HERE/'scenario-native-logs';logs.mkdir(exist_ok=True)

# mix-joystick-rit-dac

Compose a board monitor using Joystick, RIT, DAC. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. DAC holds a static voltage; this combination makes no audio-frequency claim. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

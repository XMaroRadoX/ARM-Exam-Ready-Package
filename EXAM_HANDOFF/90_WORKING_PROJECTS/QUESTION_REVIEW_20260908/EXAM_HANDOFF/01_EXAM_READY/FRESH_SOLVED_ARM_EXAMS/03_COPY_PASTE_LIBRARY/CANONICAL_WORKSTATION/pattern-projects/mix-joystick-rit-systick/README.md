# mix-joystick-rit-systick

Compose a board monitor using Joystick, RIT, SysTick. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

...
Compose a board monitor using LED, SysTick, ADC. ADC sets the value and analog amplitude. LEDs show the low eight bits. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

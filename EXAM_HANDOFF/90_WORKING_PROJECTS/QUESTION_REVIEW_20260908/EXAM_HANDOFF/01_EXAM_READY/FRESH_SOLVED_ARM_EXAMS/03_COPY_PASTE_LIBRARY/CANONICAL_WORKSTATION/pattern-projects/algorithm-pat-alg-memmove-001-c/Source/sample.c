...
void *algorithm_algorithm_pat_alg_memmove_001_c(void *d, const void *s, uint32_t n);



static int pattern_core_vector(void) {
  char a[6] = "abcd";
  algorithm_algorithm_pat_alg_memmove_001_c(a + 1, a, 4);
  return a[0] == 'a' && a[1] == 'a' && a[4] == 'd';
}
static int pattern_edge_vectors(void) {
  char a[6] = "abcd";
  algorithm_algorithm_pat_alg_memmove_001_c(a, a, 4);
  algorithm_algorithm_pat_alg_memmove_001_c(a, a + 1, 3);
  return a[0] == 'b' && a[2] == 'd';
}

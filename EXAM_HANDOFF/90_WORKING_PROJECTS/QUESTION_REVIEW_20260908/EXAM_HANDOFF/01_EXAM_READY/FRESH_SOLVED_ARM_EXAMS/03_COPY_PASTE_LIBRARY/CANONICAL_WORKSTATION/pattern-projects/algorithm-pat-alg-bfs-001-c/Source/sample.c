...
static int pattern_core_vector(void) {
  ...
  uint32_t q[3];
  return algorithm_algorithm_pat_alg_bfs_001_c(a, 3, 0, s, q) == 3;
}
static int pattern_edge_vectors(void) {
  uint8_t a[1] = {0}, s[1] = {0};
  uint32_t q[1];
  return algorithm_algorithm_pat_alg_bfs_001_c(a, 1, 0, s, q) == 1 &&
         algorithm_algorithm_pat_alg_bfs_001_c(a, 1, 1, s, q) == 0 &&
         algorithm_algorithm_pat_alg_bfs_001_c(NULL, 1, 0, s, q) == 0;
}

...
static int pattern_core_vector(void) {
  int32_t a[] = {1, 2, 3}, o[2];
  return algorithm_algorithm_pat_alg_moving_average_001_c(a, 3, 2, o) == 2 && o[0] == 1 && o[1] == 2;
}
static int pattern_edge_vectors(void) {
  int32_t a[] = {1, 2, 3}, o[3];
  return algorithm_algorithm_pat_alg_moving_average_001_c(a, 3, 0, o) == 0 &&
         algorithm_algorithm_pat_alg_moving_average_001_c(a, 3, 4, o) == 0 &&
         algorithm_algorithm_pat_alg_moving_average_001_c(a, 3, 1, o) == 3 && o[2] == 3;
}

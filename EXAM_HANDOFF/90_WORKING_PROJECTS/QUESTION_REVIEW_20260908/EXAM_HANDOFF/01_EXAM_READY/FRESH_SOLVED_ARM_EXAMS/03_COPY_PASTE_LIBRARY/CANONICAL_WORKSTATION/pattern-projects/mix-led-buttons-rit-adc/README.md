# mix-led-buttons-rit-adc

Compose a board monitor using LED, Buttons, RIT, ADC. INT0 toggles running and KEY1 selects the output mode. ADC sets the value and analog amplitude. LEDs show the low eight bits. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

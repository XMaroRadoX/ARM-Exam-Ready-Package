...
Every two seconds test the next source value and display the result as a one-hot LED value.
...
- 2023-07-04-Q2: main; answer_timer1; Timer1 IRQ advances the source array; 2000 ms

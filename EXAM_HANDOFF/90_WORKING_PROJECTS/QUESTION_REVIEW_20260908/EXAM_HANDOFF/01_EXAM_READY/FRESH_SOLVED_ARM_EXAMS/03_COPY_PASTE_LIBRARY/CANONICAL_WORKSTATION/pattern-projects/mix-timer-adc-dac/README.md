...
Compose a board monitor using Timer, ADC, DAC. ADC sets the value and analog amplitude. Timer1 streams an eight-sample waveform at 8 kHz. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

...
The API index is the GPIO bit number. Physical LED11 is index 0 and physical
LED4 is index 7. For a physical label from 4 to 11, use `11 - label` as the index.

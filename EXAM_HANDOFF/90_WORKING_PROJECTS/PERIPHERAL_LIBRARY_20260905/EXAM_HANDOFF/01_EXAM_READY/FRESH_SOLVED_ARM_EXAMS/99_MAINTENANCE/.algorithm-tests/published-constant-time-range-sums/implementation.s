; Matching Cortex-M3 Thumb implementation generated from the repaired reference.c.
        ...
        THUMB
        PRESERVE8
        EXPORT algorithm_constant_time_range_sums
        EXPORT algorithm_constant_time_range_sums_range
        ALIGN 2
algorithm_constant_time_range_sums
        cmp	r2, #0
        itt	eq
        moveq	r0, #0
        bxeq	lr
...
_Lfunc_end0
        ALIGN 2
algorithm_constant_time_range_sums_range
        mov	r12, r0
        cmp	r3, r1
        mov.w	r0, #0
        it	ls

...
static int pattern_core_vector(void) {
  uint32_t a[4];
  return algorithm_indirect_index_recurrence(a, 4) == 4 && a[0] == 0 && a[1] == 1 &&
         a[2] == 3 && a[3] == 6;
}
static int pattern_edge_vectors(void) {
  uint32_t a[8], q[8];
  return algorithm_indirect_index_recurrence(NULL, 1) == 0 &&
         algorithm_indirect_index_recurrence(a, 1) == 1 && a[0] == 0 &&
         algorithm_indirect_index_recurrence_hofstadter_q(q, 6) == 6 && q[5] == 4;
}

...
int pat_ds_stack_001(int32_t *a, uint32_t cap, uint32_t *top, int push,
                     int32_t *value) {
...
static int pattern_edge_vectors(void) {
  int32_t guarded[1]={7},v_bad=9;uint32_t top_bad=2;if(pat_ds_stack_001(guarded,1,&top_bad,0,&v_bad)||v_bad!=9) return 0;
  int32_t a[1], v = 1, o = 0;
  uint32_t top = 0;

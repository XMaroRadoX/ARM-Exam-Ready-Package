# mix-buttons-rit-systick

Compose a board monitor using Buttons, RIT, SysTick. INT0 toggles running and KEY1 selects the output mode. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

...
uint64_t algorithm_algorithm_pat_alg_packed_matmul_001_c(uint64_t a, uint64_t b);



static int pattern_core_vector(void) {
  uint64_t i = UINT64_C(0x8040201008040201);
  return algorithm_algorithm_pat_alg_packed_matmul_001_c(i, i) == i;
}
static int pattern_edge_vectors(void) {
  uint64_t identity = UINT64_C(0x8040201008040201);
  return algorithm_algorithm_pat_alg_packed_matmul_001_c(0, identity) == 0 &&
         algorithm_algorithm_pat_alg_packed_matmul_001_c(identity, 0) == 0;
}

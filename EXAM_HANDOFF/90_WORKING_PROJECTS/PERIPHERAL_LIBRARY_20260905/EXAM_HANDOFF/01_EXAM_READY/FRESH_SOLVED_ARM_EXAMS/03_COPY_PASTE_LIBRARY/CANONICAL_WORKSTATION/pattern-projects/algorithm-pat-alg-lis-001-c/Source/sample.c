...
static int pattern_core_vector(void) {
  int32_t a[] = {3, 1, 2, 5};
  uint32_t d[4];
  return algorithm_algorithm_pat_alg_lis_001_c(a, 4, d) == 3;
}
static int pattern_edge_vectors(void) {
  int32_t a[] = {2, 2, 2};
  uint32_t d[3];
  return algorithm_algorithm_pat_alg_lis_001_c(a, 0, d) == 0 && algorithm_algorithm_pat_alg_lis_001_c(a, 3, d) == 1;
}

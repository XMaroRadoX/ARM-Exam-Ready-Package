# mix-timer-rit-systick-adc

Compose a board monitor using Timer, RIT, SysTick, ADC. ADC sets the value and analog amplitude. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

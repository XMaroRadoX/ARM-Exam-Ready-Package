# mix-led-joystick-rit-adc

Compose a board monitor using LED, Joystick, RIT, ADC. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. ADC sets the value and analog amplitude. LEDs show the low eight bits. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

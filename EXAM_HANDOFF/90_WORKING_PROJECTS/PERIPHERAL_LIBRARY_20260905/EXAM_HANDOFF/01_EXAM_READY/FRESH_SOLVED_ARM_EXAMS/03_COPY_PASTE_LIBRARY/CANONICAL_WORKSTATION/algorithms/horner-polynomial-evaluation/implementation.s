; Matching Cortex-M3 Thumb implementation generated from the repaired reference.c.
        ...
        THUMB
        PRESERVE8
        EXPORT algorithm_horner_polynomial_evaluation
        EXPORT algorithm_horner_polynomial_evaluation_checked
        IMPORT __aeabi_ldivmod
        IMPORT __aeabi_uldivmod
        ALIGN 2
algorithm_horner_polynomial_evaluation
        mov	r12, r0
        cmp	r0, #0
        mov.w	r0, #0
        beq	_LBB0_5
...
_Lfunc_end0
        ALIGN 2
algorithm_horner_polynomial_evaluation_checked
        push	{r4, r5, r6, r7, lr}
        add	r7, sp, #12

# task-reaction-systick

INT0 arms; one second later all LEDs light; KEY1 captures elapsed 10 ms units; early KEY1 is false start.

## Run and inspect

Arm; 100 total waiting steps open the window. KEY1 after 7 waiting-response steps records 7.

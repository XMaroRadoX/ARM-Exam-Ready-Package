...
void algorithm_algorithm_pat_alg_heap_sort_001_assembly(int32_t *a, uint32_t n);



static int pattern_core_vector(void) {
  int32_t a[] = {3, -1, 2};
  algorithm_algorithm_pat_alg_heap_sort_001_assembly(a, 3);
...
static int pattern_edge_vectors(void) {
  ...
  int32_t a[] = {2, 2, 1};
  algorithm_algorithm_pat_alg_heap_sort_001_assembly(a, 0);
  algorithm_algorithm_pat_alg_heap_sort_001_assembly(a, 3);

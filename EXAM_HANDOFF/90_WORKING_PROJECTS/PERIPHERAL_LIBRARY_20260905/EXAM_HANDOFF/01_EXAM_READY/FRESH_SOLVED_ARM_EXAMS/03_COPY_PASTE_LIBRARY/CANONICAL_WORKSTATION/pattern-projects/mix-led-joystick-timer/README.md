# mix-led-joystick-timer

Compose a board monitor using LED, Joystick, Timer. Joystick RIGHT/LEFT adjust the value and SELECT changes mode. LEDs show the low eight bits. Inspect app, output_ticks and supervisor_ticks in the debugger for components without a visible output.

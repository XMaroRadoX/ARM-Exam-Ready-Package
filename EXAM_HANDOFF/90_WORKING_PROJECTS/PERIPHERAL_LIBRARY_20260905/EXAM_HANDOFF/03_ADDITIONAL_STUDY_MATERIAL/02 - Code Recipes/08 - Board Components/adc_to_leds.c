/* Complete project and replacement instructions: ../../../01_EXAM_READY/FRESH_SOLVED_ARM_EXAMS/03_COPY_PASTE_LIBRARY/CANONICAL_WORKSTATION/pattern-projects/adc-button-sequence/README.md
 * Open ../../../01_EXAM_READY/FRESH_SOLVED_ARM_EXAMS/03_COPY_PASTE_LIBRARY/CANONICAL_WORKSTATION/pattern-projects/adc-button-sequence/sample.uvprojx; use its matching assembly file. */
#include "exam_api.h"
#include "LPC17xx.h"
